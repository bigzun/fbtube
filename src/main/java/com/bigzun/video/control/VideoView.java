 ...
 * album art during playback, and displays playback controls using a {@link VideoControl}.
 * <p>
 ...
 * inflated by the child {@link VideoControl}. See below for more details.
 * <ul>
 * <li>Corresponding method: None</li>
 * <li>Default: {@code R.id.exo_playback_control_view}</li>
 * </ul>
 * <li>All attributes that can be set on a {@link VideoControl} can also be set on a
 * SimpleExoPlayerView, and will be propagated to the inflated {@link VideoControl}.
 * </li>
 * </ul>
 * <p>
...
public final class VideoView extends FrameLayout {
    ...
    private final VideoControl controller;
    ...
    public VideoView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int playerLayoutId = R.layout.video_view;
        boolean useArtwork = true;
        boolean useController = true;
        int surfaceType = SURFACE_TYPE_SURFACE_VIEW;
        int resizeMode = AspectRatioFrameLayout.RESIZE_MODE_FIT;
        int controllerShowTimeoutMs = VideoControl.DEFAULT_SHOW_TIMEOUT_MS;
        if (attrs != null) {
        ...
        if (controllerPlaceholder != null) {
            ...
            // calls to set them.
            this.controller = new VideoControl(context, attrs);
    ...
    /**
     * Set the {@link VideoControl.VisibilityListener}.
     *
     * @param listener The listener to be notified about visibility changes.
     */
    public void setControllerVisibilityListener(VideoControl.VisibilityListener listener) {
        Assertions.checkState(controller != null);
        controller.setVisibilityListener(listener);
    }

    /**
     * Sets the {@link VideoControl.SeekDispatcher}.
     *
     * @param seekDispatcher The {@link VideoControl.SeekDispatcher}, or null to use
     *                       {@link VideoControl#DEFAULT_SEEK_DISPATCHER}.
     */
    public void setSeekDispatcher(VideoControl.SeekDispatcher seekDispatcher) {
        Assertions.checkState(controller != null);
